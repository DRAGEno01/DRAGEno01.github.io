...
var btnb = document.getElementById("dabdad")
...
function reloadSmashndab() {
    document.getElementById('smashndabiframe').contentWindow.location.reload();
}
...
var countDownDatea = new Date("June 14, 2024 13:10:00").getTime();
var countDownDateb = new Date("June 21, 2024 13:10:00").getTime();
var countDownDatec = new Date("June 28, 2024 13:10:00").getTime();
...
var xa = setInterval(function () {
    ...
    if (distancea < 0) {
        ...
        document.getElementById("sessone").style.display = "none"
    }
}, 1000);
...
var xb = setInterval(function () {
    ...
    if (distanceb < 0) {
        ...
        document.getElementById("sesstwo").style.display = "none"
    }
}, 1000);
...
var xc = setInterval(function () {
    ...
    if (distancec < 0) {
        ...
        document.getElementById("sessthree").style.display = "none"
    }
}, 1000);
